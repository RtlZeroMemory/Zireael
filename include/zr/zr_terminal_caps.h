...
#define ZR_TERM_CAP_ALL_MASK                                                                                           \
  ((zr_terminal_cap_flags_t)(ZR_TERM_CAP_SIXEL | ZR_TERM_CAP_KITTY_GRAPHICS | ZR_TERM_CAP_ITERM2_IMAGES |            \
                             ZR_TERM_CAP_UNDERLINE_STYLES | ZR_TERM_CAP_COLORED_UNDERLINES |                         \
                             ZR_TERM_CAP_HYPERLINKS | ZR_TERM_CAP_GRAPHEME_CLUSTERS | ZR_TERM_CAP_OVERLINE |         \
                             ZR_TERM_CAP_PIXEL_MOUSE | ZR_TERM_CAP_KITTY_KEYBOARD | ZR_TERM_CAP_MOUSE |              \
                             ZR_TERM_CAP_BRACKETED_PASTE | ZR_TERM_CAP_FOCUS_EVENTS | ZR_TERM_CAP_OSC52 |            \
                             ZR_TERM_CAP_SYNC_UPDATE | ZR_TERM_CAP_SCROLL_REGION | ZR_TERM_CAP_CURSOR_SHAPE |        \
                             ZR_TERM_CAP_OUTPUT_WAIT_WRITABLE))
