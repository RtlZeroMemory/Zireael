...
zr_result_t zr_fb_draw_hline(zr_fb_painter_t* p, int32_t x, int32_t y, int32_t len,
                             const zr_style_t* style);
zr_result_t zr_fb_draw_vline(zr_fb_painter_t* p, int32_t x, int32_t y, int32_t len,
                             const zr_style_t* style);
