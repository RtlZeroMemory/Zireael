...
static _Atomic(zr_posix_sa_handler_fn) g_posix_prev_sa_handler = 0;
static _Atomic(zr_posix_sa_sigaction_fn) g_posix_prev_sa_sigaction = 0;
...
static void zr_posix_sigwinch_publish_previous(const struct sigaction* prev) {
  ...
  atomic_store_explicit(&g_posix_prev_sa_handler, 0, memory_order_relaxed);
  atomic_store_explicit(&g_posix_prev_sa_sigaction, 0, memory_order_relaxed);
