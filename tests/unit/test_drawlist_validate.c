...
const uint8_t zr_test_dl_fixture1[] = {
    ...
    ZR_DL_CMD_HDR(ZR_DL_OP_DEF_STRING, 20u), ZR_U32LE(1u), ZR_U32LE(2u), (uint8_t)'H', (uint8_t)'i', (uint8_t)0u,
    (uint8_t)0u,
...
const uint8_t zr_test_dl_fixture3[] = {
    ...
    ZR_DL_CMD_HDR(ZR_DL_OP_DEF_STRING, 24u), ZR_U32LE(1u), ZR_U32LE(6u), (uint8_t)'A', (uint8_t)'B', (uint8_t)'C',
    (uint8_t)'D', (uint8_t)'E', (uint8_t)'F', (uint8_t)0u, (uint8_t)0u,

    ZR_DL_CMD_HDR(ZR_DL_OP_DEF_BLOB, 100u), ZR_U32LE(1u), ZR_U32LE(84u),
    ...
    ZR_DL_CMD_HDR(ZR_DL_OP_DRAW_TEXT_RUN, 24u), ZR_I32LE(0), ZR_I32LE(0), ZR_U32LE(1u), ZR_U32LE(0u),
};
...
const uint8_t zr_test_dl_fixture4[] = {
    ...
    ZR_DL_CMD_HDR(ZR_DL_OP_DEF_STRING, 20u), ZR_U32LE(1u), ZR_U32LE(4u), 0xE7u, 0x95u, 0x8Cu, (uint8_t)'A',
...
const uint8_t zr_test_dl_fixture5_v2_cursor[] = {
    ...
    ZR_DL_CMD_HDR(ZR_DL_OP_SET_CURSOR, 20u), ZR_I32LE(3), ZR_I32LE(4), (uint8_t)2u, (uint8_t)1u, (uint8_t)1u,
    (uint8_t)0u,
};
...
const uint8_t zr_test_dl_fixture6_v1_draw_text_slices[] = {
    ...
    ZR_DL_CMD_HDR(ZR_DL_OP_DEF_STRING, 24u), ZR_U32LE(1u), ZR_U32LE(5u), (uint8_t)'H', (uint8_t)'e', (uint8_t)'l',
    (uint8_t)'l', (uint8_t)'o', (uint8_t)0u, (uint8_t)0u, (uint8_t)0u,
...
const uint8_t zr_test_dl_fixture7_v3_text_link[] = {
    ...
    ZR_DL_CMD_HDR(ZR_DL_OP_DEF_STRING, 20u), ZR_U32LE(1u), ZR_U32LE(1u), (uint8_t)'X', (uint8_t)0u, (uint8_t)0u,
    (uint8_t)0u,

    ZR_DL_CMD_HDR(ZR_DL_OP_DEF_STRING, 28u), ZR_U32LE(2u), ZR_U32LE(9u), (uint8_t)'h', (uint8_t)'t', (uint8_t)'t',
    (uint8_t)'p', (uint8_t)'s', (uint8_t)':', (uint8_t)'/', (uint8_t)'/', (uint8_t)'x', (uint8_t)0u, (uint8_t)0u,
    (uint8_t)0u,

    ZR_DL_CMD_HDR(ZR_DL_OP_DEF_STRING, 20u), ZR_U32LE(3u), ZR_U32LE(3u), (uint8_t)'i', (uint8_t)'d', (uint8_t)'1',
    (uint8_t)0u,
