...
ZR_TEST_UNIT(engine_submit_drawlist_rejects_negotiated_version_mismatch) {
  ...
  ZR_ASSERT_TRUE(engine_submit_drawlist(e, zr_test_dl_fixture5_v2_cursor, (int)zr_test_dl_fixture5_v2_cursor_len) ==
                 ZR_ERR_UNSUPPORTED);
  engine_destroy(e);
}
...
ZR_TEST_UNIT(engine_submit_drawlist_version_mismatch_has_no_partial_effects) {
  ...
  ZR_ASSERT_TRUE(engine_submit_drawlist(e2, zr_test_dl_fixture5_v2_cursor, (int)zr_test_dl_fixture5_v2_cursor_len) ==
                 ZR_ERR_UNSUPPORTED);
